...
class Linear:
    ...
    def predict_linear_model_classification(points):
     ...
     def predict_linear_model_regression(points):
    ...
    def train_linear_model_classification(x, y, result_size, nb_iter, alpha):
    ...
    def train_linear_model_regression(x, y, x_size):
