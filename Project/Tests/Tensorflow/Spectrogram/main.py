...
model = keras.models.Sequential([
    keras.layers.Conv2D(8, (3, 3), padding='same', activation=keras.activations.relu),
...
model.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
model.fit(train_images, train_labels, validation_data=(validation_images, validation_labels), epochs=100,  callbacks=[CustomCallback(), keras.callbacks.TensorBoard(log_dir='logs/mlp_4conv_relu_adam_grey')])
